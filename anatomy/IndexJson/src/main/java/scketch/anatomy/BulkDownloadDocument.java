...
public class BulkDownloadDocument {
...
//        }
        ...
        for (int cnt = 0; cnt < _files.length; cnt++) {
            ...
            System.out.println(_es.readingDocument(indexName));
            System.out.println(_es.searchAfterDocument(indexName,-1,-1,10000,new FileOutputStream(String.format("/home/data/searchAfter-%s.json",indexName),false)));
        }
        _es.close();
