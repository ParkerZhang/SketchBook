...
const ollamaConfiguredUrl = cfg?.models?.providers?.ollama?.apiBaseUrl?.trim();
const OLLAMA_BASE_URL = ollamaConfiguredUrl ?? process.env.OLLAMA_HOST?.trim() ?? OLLAMA_NATIVE_BASE_URL;
